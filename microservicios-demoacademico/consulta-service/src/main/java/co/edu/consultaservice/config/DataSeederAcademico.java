package co.edu.consultaservice.config;
...
import co.edu.consultaservice.repository.ProgramaRepository;
...
public class DataSeederAcademico {
    ...
    CommandLineRunner seedAcademico(
        ...
        return args -> {
            ...
            if (programaRepo.count() > 0 || asignaturaRepo.count() > 0 || grupoRepo.count() > 0)
                return;
